...
type ListRacesRequest struct {
	...
	SortBy *ListRacesSortBy        `protobuf:"bytes,2,opt,name=sort_by,json=sortBy,proto3" json:"sort_by,omitempty"`
	Order  *ListRacesOrder         `protobuf:"bytes,3,opt,name=order,proto3" json:"order,omitempty"`
}
...
func (x *ListRacesRequest) GetSortBy() *ListRacesSortBy {
	if x != nil {
		return x.SortBy
	}
	return nil
...
func (x *ListRacesRequest) GetOrder() *ListRacesOrder {
	if x != nil {
		return x.Order
	}
	return nil
...
// Display order ascending or descending for listing races
type ListRacesOrder struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *ListRacesOrder) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ListRacesOrder) ProtoMessage() {}

func (x *ListRacesOrder) ProtoReflect() protoreflect.Message {
	mi := &file_racing_racing_proto_msgTypes[3]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ListRacesOrder.ProtoReflect.Descriptor instead.
func (*ListRacesOrder) Descriptor() ([]byte, []int) {
	return file_racing_racing_proto_rawDescGZIP(), []int{3}
}

func (x *ListRacesOrder) GetOrder() int64 {
	if x != nil {
		return x.Order
	}
	return 0
...
// Sort by column for listing races
type ListRacesSortBy struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (*ListRacesSortBy) ProtoMessage() {}

func (x *ListRacesSortBy) ProtoReflect() protoreflect.Message {
	mi := &file_racing_racing_proto_msgTypes[4]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ListRacesSortBy.ProtoReflect.Descriptor instead.
func (*ListRacesSortBy) Descriptor() ([]byte, []int) {
	return file_racing_racing_proto_rawDescGZIP(), []int{4}
}

func (x *ListRacesSortBy) GetColumn() int64 {
	if x != nil {
		return x.Column
	}
	return 0
...
type Race struct {
	...
	// Status represents the status of the race based on the AdvertisedStartTime
...
var file_racing_racing_proto_rawDesc = []byte{
	...
	0x72, 0x52, 0x06, 0x66, 0x69, 0x6c, 0x74, 0x65, 0x72, 0x12, 0x30, 0x0a, 0x07, 0x73, 0x6f, 0x72,
	0x74, 0x5f, 0x62, 0x79, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x17, 0x2e, 0x72, 0x61, 0x63,
	0x69, 0x6e, 0x67, 0x2e, 0x4c, 0x69, 0x73, 0x74, 0x52, 0x61, 0x63, 0x65, 0x73, 0x53, 0x6f, 0x72,
	0x74, 0x42, 0x79, 0x52, 0x06, 0x73, 0x6f, 0x72, 0x74, 0x42, 0x79, 0x12, 0x2c, 0x0a, 0x05, 0x6f,
	0x72, 0x64, 0x65, 0x72, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x16, 0x2e, 0x72, 0x61, 0x63,
	0x69, 0x6e, 0x67, 0x2e, 0x4c, 0x69, 0x73, 0x74, 0x52, 0x61, 0x63, 0x65, 0x73, 0x4f, 0x72, 0x64,
	0x65, 0x72, 0x52, 0x05, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x22, 0x37, 0x0a, 0x11, 0x4c, 0x69, 0x73,
	...
	0x65, 0x73, 0x22, 0x5c, 0x0a, 0x16, 0x4c, 0x69, 0x73, 0x74, 0x52, 0x61, 0x63, 0x65, 0x73, 0x52,
	...
	0x22, 0x26, 0x0a, 0x0e, 0x4c, 0x69, 0x73, 0x74, 0x52, 0x61, 0x63, 0x65, 0x73, 0x4f, 0x72, 0x64,
	0x65, 0x72, 0x12, 0x14, 0x0a, 0x05, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x18, 0x01, 0x20, 0x01, 0x28,
	0x03, 0x52, 0x05, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x22, 0x29, 0x0a, 0x0f, 0x4c, 0x69, 0x73, 0x74,
	0x52, 0x61, 0x63, 0x65, 0x73, 0x53, 0x6f, 0x72, 0x74, 0x42, 0x79, 0x12, 0x16, 0x0a, 0x06, 0x63,
	0x6f, 0x6c, 0x75, 0x6d, 0x6e, 0x18, 0x01, 0x20, 0x01, 0x28, 0x03, 0x52, 0x06, 0x63, 0x6f, 0x6c,
	0x75, 0x6d, 0x6e, 0x22, 0x20, 0x0a, 0x0e, 0x47, 0x65, 0x74, 0x52, 0x61, 0x63, 0x65, 0x52, 0x65,
	...
	0x52, 0x61, 0x63, 0x65, 0x52, 0x04, 0x72, 0x61, 0x63, 0x65, 0x22, 0xf3, 0x01, 0x0a, 0x04, 0x52,
	...
	0x74, 0x61, 0x72, 0x74, 0x54, 0x69, 0x6d, 0x65, 0x12, 0x1b, 0x0a, 0x06, 0x73, 0x74, 0x61, 0x74,
	0x75, 0x73, 0x18, 0x07, 0x20, 0x01, 0x28, 0x09, 0x48, 0x00, 0x52, 0x06, 0x73, 0x74, 0x61, 0x74,
	...
	0x72, 0x61, 0x63, 0x65, 0x73, 0x3a, 0x01, 0x2a, 0x12, 0x52, 0x0a, 0x07, 0x47, 0x65, 0x74, 0x52,
...
var file_racing_racing_proto_goTypes = []interface{}{
	...
	(*ListRacesOrder)(nil),         // 3: racing.ListRacesOrder
	(*ListRacesSortBy)(nil),        // 4: racing.ListRacesSortBy
...
var file_racing_racing_proto_depIdxs = []int32{
	...
	4, // 1: racing.ListRacesRequest.sort_by:type_name -> racing.ListRacesSortBy
	3, // 2: racing.ListRacesRequest.order:type_name -> racing.ListRacesOrder
	...
	0, // 6: racing.Racing.ListRaces:input_type -> racing.ListRacesRequest
	5, // 7: racing.Racing.GetRace:input_type -> racing.GetRaceRequest
	1, // 8: racing.Racing.ListRaces:output_type -> racing.ListRacesResponse
	6, // 9: racing.Racing.GetRace:output_type -> racing.GetRaceResponse
...
func file_racing_racing_proto_init() {
	...
	file_racing_racing_proto_msgTypes[7].OneofWrappers = []interface{}{}
	type x struct{}
